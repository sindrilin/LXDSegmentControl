...
- (void)setupConfiguration
{
    switch (_controlType) {
        ...
        case LXDSegmentControlTypeSeparate:
 ...
 *  分隔属性
 */
- (void)separateConfiguration
{
    self.itemNormalScale = INITSCALE;
    self.itemSelectScale = INITSCALE;
    self.backgroundColor = CLEAR_COLOR;
    self.itemBackgroundColor = CLEAR_COLOR;
    self.itemSelectedColor = CLEAR_COLOR;
    self.itemTextColor = kRGB(91, 91, 91);
    self.itemSelectedTextColor = kRGB(123, 189, 229);
    self.animationDuration = ANIMATION_DURATION;
    self.slideBlockColor = CLEAR_COLOR;
    self.separateItemColor = kRGB(204, 204, 204);
}
